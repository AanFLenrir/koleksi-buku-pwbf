{{--
=============================================================
HALAMAN DATA BUKU – Epic Farm Futuristik
=============================================================
Fitur: Tampilkan, Tambah, Edit, Hapus (dengan modal konfirmasi)
Semua fungsi backend tetap utuh, hanya desain dan UX ditingkatkan.
=============================================================
--}}

@extends('layouts.app')

@section('title', 'Data Buku - FarmNex')

@push('styles')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* ==========================================================
           EPIC FARM THEME – Data Buku
           ========================================================== */
        ...
        .sun-buku {
            ...
            animation: pulseSunBuku 4s ease-in-out infinite alternate;
            z-index: 1;
            pointer-events: none;
        }

        @keyframes pulseSunBuku {
        ...
        .cloud-buku {
            ...
            z-index: 1;
            pointer-events: none;
            animation: moveCloudBuku 25s linear infinite;
        }
        ...
        .grass-buku::before {
            ...
            animation: swayGrassBuku 3s ease-in-out infinite alternate;
        }

        @keyframes swayGrassBuku {
        ...
        .walking-animals-buku {
            ...
            display: flex;
            justify-content: space-around;
            animation: walkBuku 20s linear infinite;
        }

        .walking-animals-buku i {
            font-size: 2.5rem;
            color: #4e342e;
            filter: drop-shadow(0 4px 6px rgba(0,0,0,0.2));
            animation: bounceBuku 1.2s ease-in-out infinite alternate;
        }

        .walking-animals-buku i:nth-child(1) { animation-delay: 0s; }
        .walking-animals-buku i:nth-child(2) { animation-delay: 0.4s; font-size: 2rem; }
        .walking-animals-buku i:nth-child(3) { animation-delay: 0.8s; font-size: 3rem; }
        ...
        .floating-farm-buku i {
            position: absolute;
            font-size: 3.5rem;
            color: rgba(255, 215, 0, 0.08);
            animation: floatBuku 18s ease-in-out infinite;
            filter: drop-shadow(0 0 10px rgba(255,215,0,0.1));
        }

        .floating-farm-buku i:nth-child(1) { top: 15%; left: 5%; animation-delay: 0s; font-size: 4rem; }
        .floating-farm-buku i:nth-child(2) { top: 30%; right: 10%; animation-delay: 4s; font-size: 5rem; }
        .floating-farm-buku i:nth-child(3) { bottom: 40%; left: 8%; animation-delay: 8s; }
        .floating-farm-buku i:nth-child(4) { bottom: 30%; right: 6%; animation-delay: 12s; font-size: 3.5rem; }
        ...
        @media (max-width: 768px) {
            ...
            .floating-farm-buku i { display: none; }
            .walking-animals-buku { display: none; }
            .fence-buku { display: none; }
            .grass-buku { height: 30px; }
            .cloud-buku { display: none; }
            .sun-buku { width: 40px; height: 40px; top: 15px; right: 20px; }
        }
    </style>
@endpush
...
@section('content')
    {{-- ===== DEKORASI ===== --}}
    <div class="sun-buku"></div>
    <div class="cloud-buku cloud-buku-1"></div>
    <div class="cloud-buku cloud-buku-2"></div>
    <div class="grass-buku"></div>
    <div class="fence-buku">
    ...
    <div class="walking-animals-buku">
        <i class="fas fa-cow"></i>
        <i class="fas fa-horse"></i>
        <i class="fas fa-kiwi-bird"></i>
    </div>
    <div class="floating-farm-buku">
        <i class="fas fa-cow"></i>
        <i class="fas fa-kiwi-bird"></i>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" 
                                                    ...
                                                    onclick="openDeleteModal('{{ $item->idbuku }}', '{{ $item->judul }}')">
    ...
    <div class="modal-confirm" id="deleteModal">
        <div class="modal-box">
            ...
            <h5>Hapus Buku?</h5>
            <p id="deleteModalMessage">Apakah Anda yakin ingin menghapus buku <strong>"..."</strong>? Tindakan ini tidak dapat dibatalkan.</p>
            <div class="btn-group">
...
<script>
    ...
    function openDeleteModal(id, name) {
        ...
        document.getElementById('deleteModalMessage').innerHTML = 
            'Apakah Anda yakin ingin menghapus buku <strong>"' + name + '"</strong>? Tindakan ini tidak dapat dibatalkan.';
