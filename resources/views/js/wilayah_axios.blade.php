...
@section('title', 'Wilayah Axios - FarmNex')
...
@push('styles')
    ...
    <style>
        ...
        .sun-wilayah-axios {
            ...
            animation: pulseSunWilayahAxios 4s ease-in-out infinite alternate;
            z-index: 1;
            pointer-events: none;
        }

        @keyframes pulseSunWilayahAxios {
        ...
        .cloud-wilayah-axios {
            ...
            z-index: 1;
            pointer-events: none;
            animation: moveCloudWilayahAxios 25s linear infinite;
        }

        .cloud-wilayah-axios::before,
        .cloud-wilayah-axios::after {
            content: '';
            position: absolute;
            background: inherit;
            border-radius: 50%;
        ...
        .cloud-wilayah-axios-1::before {
            width: 70px;
            height: 70px;
            top: -30px;
            left: 20px;
        }
        .cloud-wilayah-axios-1::after {
            width: 100px;
            height: 80px;
            top: -40px;
            left: 70px;
        ...
        .cloud-wilayah-axios-2::before {
            width: 90px;
            height: 90px;
            top: -40px;
            left: 30px;
        }
        .cloud-wilayah-axios-2::after {
            width: 120px;
            height: 100px;
            top: -50px;
            left: 90px;
        ...
        @keyframes moveCloudWilayahAxios {
        ...
        .grass-wilayah-axios::before {
            ...
            animation: swayGrassWilayahAxios 3s ease-in-out infinite alternate;
        }

        @keyframes swayGrassWilayahAxios {
        ...
        .fence-wilayah-axios .post::before {
            content: '';
            position: absolute;
            top: 50%;
            left: -15px;
        ...
        .walking-animals-wilayah-axios {
            ...
            display: flex;
            justify-content: space-around;
            animation: walkWilayahAxios 20s linear infinite;
        }

        .walking-animals-wilayah-axios i {
            font-size: 2.5rem;
            color: #4e342e;
            filter: drop-shadow(0 4px 6px rgba(0,0,0,0.2));
            animation: bounceWilayahAxios 1.2s ease-in-out infinite alternate;
        }

        .walking-animals-wilayah-axios i:nth-child(1) { animation-delay: 0s; }
        .walking-animals-wilayah-axios i:nth-child(2) { animation-delay: 0.4s; font-size: 2rem; }
        .walking-animals-wilayah-axios i:nth-child(3) { animation-delay: 0.8s; font-size: 3rem; }

        @keyframes walkWilayahAxios {
            0% { transform: translateX(-150px); }
            100% { transform: translateX(calc(100vw + 150px)); }
        }

        @keyframes bounceWilayahAxios {
            0% { transform: translateY(0) rotate(-3deg); }
            100% { transform: translateY(-12px) rotate(3deg); }
        }

        /* ---------- Hewan Melayang ---------- */
        .floating-farm-wilayah-axios {
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
        ...
        .floating-farm-wilayah-axios i {
            position: absolute;
            font-size: 3.5rem;
            color: rgba(255, 215, 0, 0.08);
            animation: floatWilayahAxios 18s ease-in-out infinite;
            filter: drop-shadow(0 0 10px rgba(255,215,0,0.1));
        }

        .floating-farm-wilayah-axios i:nth-child(1) { top: 15%; left: 5%; animation-delay: 0s; font-size: 4rem; }
        .floating-farm-wilayah-axios i:nth-child(2) { top: 30%; right: 10%; animation-delay: 4s; font-size: 5rem; }
        .floating-farm-wilayah-axios i:nth-child(3) { bottom: 40%; left: 8%; animation-delay: 8s; }
        .floating-farm-wilayah-axios i:nth-child(4) { bottom: 30%; right: 6%; animation-delay: 12s; font-size: 3.5rem; }

        @keyframes floatWilayahAxios {
        ...
        @media (max-width: 768px) {
            ...
            .floating-farm-wilayah-axios i { display: none; }
            .walking-animals-wilayah-axios { display: none; }
            .fence-wilayah-axios { display: none; }
            .grass-wilayah-axios { height: 30px; }
            .cloud-wilayah-axios { display: none; }
            .sun-wilayah-axios { width: 40px; height: 40px; top: 15px; right: 20px; }
        }
    </style>
@endpush
...
@section('content')
    {{-- ===== DEKORASI ===== --}}
    <div class="sun-wilayah-axios"></div>
    <div class="cloud-wilayah-axios cloud-wilayah-axios-1"></div>
    <div class="cloud-wilayah-axios cloud-wilayah-axios-2"></div>
    <div class="grass-wilayah-axios"></div>
    <div class="fence-wilayah-axios">
    ...
    <div class="walking-animals-wilayah-axios">
        <i class="fas fa-cow"></i>
        <i class="fas fa-horse"></i>
        <i class="fas fa-kiwi-bird"></i>
    </div>
    <div class="floating-farm-wilayah-axios">
        <i class="fas fa-cow"></i>
        <i class="fas fa-kiwi-bird"></i>
